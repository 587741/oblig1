...
public class Quiz extends AppCompatActivity {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(QuestionNum == mQuestions.getLength()-1){
                    ...
                    Intent intent_result = new Intent(Quiz.this,ResultActivity.class);
    ...
    private void showMainImage (){
        ...
        mQuizzImage = findViewById(R.id.quiz_image);
        String img = mQuestions.getImages(QuestionNum);
        mQuizzImage.setImageResource(getResources().getIdentifier(img, "drawable",getPackageName()));
    }
    private void showRadioButtonAnswers(int questionNum){
        //Making buttons for answers
        ...
        for (int i= 0; i<=2; i++){
            ...
            rb1[i].setText(mQuestions.getChoice(questionNum)[i]);
